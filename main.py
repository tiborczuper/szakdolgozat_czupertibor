...
def main_menu():
    ...
    while True:
        ...
        beginner_button = Button(image=pygame.image.load("assets/images/play_BG.png"), pos=(512, 180),
                                text_input="KEZDŐ MÓD", font=get_font(60), base_color="#ffcc00", hovering_color="White")
        play_button = Button(image=pygame.image.load("assets/images/play_BG.png"), pos=(512, 300),
                             text_input="PLAY", font=get_font(60), base_color="#ffcc00", hovering_color="White")
        options_button = Button(image=pygame.image.load("assets/images/options_BG.png"), pos=(512, 420),
                                text_input="SETTINGS", font=get_font(60), base_color="#ffcc00", hovering_color="White")
        quit_button = Button(image=pygame.image.load("assets/images/quit_BG.png"), pos=(512, 540),
                             text_input="QUIT", font=get_font(60), base_color="#ffcc00", hovering_color="White")

        screen.blit(menu_text, menu_rect)

        for button in [beginner_button, play_button, options_button, quit_button]:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if beginner_button.checkForInput(mouse_pos):
                    beginner_mode(1)  # kezdő mód 1. szint
...
# --- KEZDŐ MÓD FUNKCIÓ ---
def beginner_mode(level):
    # Itt később szintenként eltérő pályaadatokat lehet megadni
    # Most csak az 1. szintet indítja el, később bővítjük
    # A szintszámot is kiírjuk a pályán
    menu_music.stop()
    # TODO: szintenként eltérő pályaadatok
    grid_size = 4
    cell_size = 100
    ...
    # Sajtlapok, egerek, stb. ugyanaz, mint a play() függvényben
    # Szintszám kiírása
    cheese_imgs = []
    cheese_rects = []
    cheese_angles = []
    num_cheese = 7
    cheese_oversize = -2
    cheese_spacing = int(cell_size * 0.85)
    cheese_start_y = 20
    for i in range(1, num_cheese + 1):
        ...
        cheese_rects.append(img.get_rect(topleft=(30, cheese_start_y + (i-1)*cheese_spacing - cheese_oversize//2)))
    ...
    while True:
        ...
        # Szintszám kiírása
        level_text = get_font(40).render(f"Kezdő mód - {level}. szint", True, "#ffcc00")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if PLAY_BACK.checkForInput(PLAY_MOUSE_POS):
                    main_menu()
                # Sajtlap húzás, forgatás logika ugyanaz, mint play()-ben
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                if dragging_idx is not None:
                    ...
                    cheese_rects[dragging_idx].topleft = (30, cheese_start_y + int(dragging_idx*cheese_spacing))
                    dragging_idx = None
...
def play():
    ...
    cell_size = 100  # kisebb cellaméret
    ...
    cheese_spacing = int(cell_size * 0.85)  # kicsit közelebb legyenek egymáshoz
    cheese_start_y = 20  # feljebb kezdjük a sajtlapokat
    for i in range(1, num_cheese + 1):
        img = pygame.image.load(f"assets/images/cheese/SAJTLAP{i}.png").convert_alpha()
        img = pygame.transform.smoothscale(
            img,
        ...
        cheese_imgs.append(img)
        # A bal oldali készletben nagyobb távolság, de feljebb kezdjük
        cheese_rects.append(img.get_rect(topleft=(30, cheese_start_y + (i-1)*cheese_spacing - cheese_oversize//2)))
        cheese_angles.append(0)
